              ...
              <div className="tab-content">
                <div className="tab-pane active show" id="tabs-tab-1">
                  <div className="row">
                    ...
                    <div className="col-lg-4 text-center order-1 order-lg-2">
                      <img src="/assets/images/services/tlsr-1.jpg" alt="" className="img-fluid" />
                    </div>
                  </div>
                </div>
                <div className="tab-pane" id="tabs-tab-2">
                  <div className="row">
                    ...
                    <div className="col-lg-4 text-center order-1 order-lg-2">
                      <img src="/assets/images/services/tlsr-2.jpg" alt="" className="img-fluid" />
                    </div>
                  </div>
                </div>
                <div className="tab-pane" id="tabs-tab-3">
                  <div className="row">
                    ...
                    <div className="col-lg-4 text-center order-1 order-lg-2">
                      <img src="/assets/images/services/tlsr-3.jpg" alt="" className="img-fluid" />
                    </div>
                  </div>
                </div>
                <div className="tab-pane" id="tabs-tab-4">
                  <div className="row">
                    ...
                    <div className="col-lg-4 text-center order-1 order-lg-2">
                      <img src="/assets/images/services/tlsr-4.jpg" alt="" className="img-fluid" />
                    </div>
                  </div>
                </div>
              </div>
