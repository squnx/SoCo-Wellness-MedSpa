          ...
          <div className="row gy-3">
            ...
            <div className="col-xl-3 col-lg-6" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="pricing-item">
                ...
                <div className="pricing-detail">
                  <ul>
                    <li>PRP therapy</li>
                    <li>Thermiva treatments</li>
                    <li>hormone therapy (optional)</li>
                  </ul>
                </div>
                <div className="btn-wrap">
            ...
            <div className="col-xl-3 col-lg-6" data-aos="fade-up" data-aos-delay="400">
              <div className="pricing-item">
                ...
                <div className="pricing-detail">
                  <ul>
                    <li>Performed by gynecologist</li>
                    <li>Poly-L-Lactic Acid</li>
                    <li>Stimulates collagen production</li>
                    <li>Restores volume & elasticity</li>
                  </ul>
                </div>
                <div className="btn-wrap">
                  <h4>$2900</h4>
              ...
              <div className="pricing-item">
                ...
                <div className="pricing-detail">
                  <ul>
                    <li>Consultation</li>
                    <li>Prescription</li>
                    <li>4 Injections/Month</li>
                    <li>Mounjaro (Tirzepatide) or</li>
                    <li>Zepbound (Recaglutide) or</li>
